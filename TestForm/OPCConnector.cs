...
{
    public partial class OPCConnector : Form
    {
        #region event
        ...
        public OPCConnector()
        {
            ...
            TagList.Add(new Tag("Channel1.Device1.testFloat", "Float"));
            TagList.Add(new Tag("Channel1.Device1.testBoolean", "Boolean"));
            TagList.Add(new Tag("Channel1.Device1.testString", "String"));
            TagList.Add(new Tag("Channel1.Device1.testInt", "Int"));
        }
        ...
        private bool SubscribeClientEvent()
        {
            Console.WriteLine("SubscribeClientEvent");
            ...
            try
            {
                ...
                for (itemIndex = 0; itemIndex < itemIdentifiers.Length; itemIndex++)
                {
                    ...
                    {
                        Console.WriteLine("Failed to add item " + itemIdentifiers[itemIndex].ItemName + " to subscription");
                    }
                }
            ...
            {
                Console.WriteLine("Handled Subscribe exception. Reason: " + ex.Message);
                return false;
            }
            return true;
        }
        ...
        {
            Console.WriteLine("daServerMgt_DataChanged enter");
                ...
                if (activeClientSubscriptionHandle == clientSubscription)
                {
                    ...
                    foreach (ItemValueCallback itemValue in itemValues)
                    {
                        ...
                        if (!string.IsNullOrEmpty(tagName))
                        {
                            ...
                            LabelUpdater u = new LabelUpdater(updateLabel);
                            lbldata.Invoke(u, data);

                            // Event For COM
                            if (OnTagValueChanged != null)
                            {
                                //Console.WriteLine(OnValueChanged.Method.ToString());
                                Console.WriteLine("Invoke OnTagValueChanged");
            ...
            {
                Console.WriteLine("Handled Data Changed exception. Reason: " + ex.Message);
            }
            Console.WriteLine("daServerMgt_DataChanged exit");
        }


        private delegate void LabelUpdater(string data);
        private void updateLabel(string data)
        {
            lbldata.Text = data;
            Console.WriteLine("updateLabel:" + data);
        }
        ...
        private void DisconnectOPCServer()
        {
            ...
            {
                Console.WriteLine("Handled Disconnect exception. Reason: " + e.Message);
            }
        ...
        private void Unsubscribe()
        {
            ...
            {
                Console.WriteLine("Handled SubscriptionCancel exception. Reason: " + e.Message);
            }
